      ...
      <div className="container-custom">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-4">
            <div className="w-14 h-14 rounded-xl overflow-hidden transform hover:scale-110 transition-transform duration-300 border-2 border-primary-500/50 bg-elite-cream/10 backdrop-blur-sm luxury-glow depth-hover">
              <img 
            ...
            <div className="hidden sm:block">
              <h1 className="text-2xl font-bold font-heading premium-text muscle-text">THE LIFT CO</h1>
