    ...
    <ClientErrorBoundary>
      ...
      <main className="min-h-screen bg-gradient-to-b from-neutral-950 via-neutral-900 to-neutral-950 pt-20 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-primary-400 mb-4">Payment Successful!</h1>
          <p className="text-neutral-300 mb-8">Thank you for your purchase. We'll be in touch soon.</p>
